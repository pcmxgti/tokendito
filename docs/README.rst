...
To configure manually, create a file ``$HOME/.aws/okta_auth`` with the URL for your Okta organization and tile.  See `okta_auth.example <okta_auth.example>`_. This file supports multiple profiles, in case there is a need to connect with different Okta Orgs and tiles.
